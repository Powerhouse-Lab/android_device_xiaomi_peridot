...
package com.android.DeviceSettings.battery;

import android.content.Context;
import android.content.res.Resources;

import com.android.DeviceSettings.utils.FileUtils;
...
public class FastChargeConfig {
    ...
    public static final String ACTION_FAST_CHARGE_SERVICE_CHANGED = "com.android.DeviceSettings.battery.FAST_CHARGE_SERVICE_CHANGED";
    ...
    private FastChargeConfig(Context context) {
        ...
        config_FastChargePath = res.getString(com.android.DeviceSettings.R.string.config_FastChargePath);
    }
